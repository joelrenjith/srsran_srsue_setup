...
class multi_ue_scenario(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ue3_path_loss_db_win = RangeWidget(self._ue3_path_loss_db_range, self.set_ue3_path_loss_db, 'UE3 Pathloss [dB]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._ue3_path_loss_db_win)
        self._ue2_path_loss_db_range = Range(0, 100, 1, 10, 200)
        self._ue2_path_loss_db_win = RangeWidget(self._ue2_path_loss_db_range, self.set_ue2_path_loss_db, 'UE2 Pathloss [dB]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._ue2_path_loss_db_win)
        self._ue1_path_loss_db_range = Range(0, 100, 1, 0, 200)
        self._ue1_path_loss_db_win = RangeWidget(self._ue1_path_loss_db_range, self.set_ue1_path_loss_db, 'UE1 Pathloss [dB]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._ue1_path_loss_db_win)
        self._slow_down_ratio_range = Range(1, 32, 1, 4, 200)
        self._slow_down_ratio_win = RangeWidget(self._slow_down_ratio_range, self.set_slow_down_ratio, 'Time Slow Down Ratio', "counter_slider", float)
        self.top_grid_layout.addWidget(self._slow_down_ratio_win)
